        ...
        <div className="contact-page-card">
          <div className="contact-page-info">
            <div className="contact-page-intro">
              ...
              <p>
                Share your query with us and we&apos;ll create your lead after a
            ...
            <div className="contact-page-info-grid">
              <div className="contact-page-info-block">
                ...
                <div>
                  ...
                  <p>Reach out for product questions, orders, or general assistance.</p>
                </div>
              </div>
              <div className="contact-page-info-block">
                <div className="contact-page-info-icon">
                ...
                <div>
                  ...
                  <p>Your email is verified with OTP before the message is submitted.</p>
                </div>
              </div>
              <div className="contact-page-info-block">
                <div className="contact-page-info-icon">
                ...
                <div>
                  ...
                  <p>Verified contact leads are easier for our team to follow up.</p>
                </div>
              </div>
            </div>
          ...
          <div className="contact-page-form-wrap">
            <div className="contact-page-form-header">
              ...
              <p>
                {verified
                  ? "Your inquiry has been verified and submitted."
                  : otpSent
                    ? `We sent a 6-digit OTP to ${form.email || "your email"}.`
                    : "Fill in your details below. We will send an OTP to your email."}
              </p>
            </div>

            {statusMessage && (
              <div className={`contact-page-alert ${statusType}`}>{statusMessage}</div>
            )}

            {!verified && (
              <div className="contact-page-progress">
                <div className={`contact-page-progress-bar step-${stepState}`} />
              </div>
            )}
            ...
            <form onSubmit={otpSent ? verifyOtp : sendOtp} className="contact-page-form">
              <div className="contact-page-grid">
                <div>
                  ...
                  />
                  {errors.firstName && (
                    <p className="contact-page-error">{errors.firstName}</p>
                  )}
                </div>
                <div>
                  ...
                  />
                  {errors.lastName && (
                    <p className="contact-page-error">{errors.lastName}</p>
                  )}
                </div>
                <div>
                  <label>Email</label>
                ...
                <div>
                  ...
                  />
                  {errors.phoneNumber && (
                    <p className="contact-page-error">{errors.phoneNumber}</p>
                  )}
                </div>
              </div>
              ...
              {otpSent && !verified && (
                <div className="contact-page-otp-panel">
                  ...
                  <div>
                    ...
                    />
                    {errors.otp && (
                      <p className="contact-page-error">{errors.otp}</p>
                    )}
                  </div>
                </div>
              )}
              ...
              <div className="contact-page-actions">
                ...
                {otpSent && !verified && (
                  <>
                    ...
                    <button
                      className="contact-page-secondary"
                      type="button"
                      onClick={resetForm}
                    >
                      Edit Form
